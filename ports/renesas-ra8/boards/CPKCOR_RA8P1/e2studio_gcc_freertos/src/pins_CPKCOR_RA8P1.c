...
const machine_pin_af_obj_t machine_pin_afs[] = {
    {
        .pin = BSP_IO_PORT_01_PIN_00,
        .peripheral = MACHINE_PIN_AF_PERIPHERAL_SCI,
        .channel = 9,
        .group = 'A',
        .signal = MACHINE_PIN_AF_SPI_SCK,
    },
    {
        .pin = BSP_IO_PORT_01_PIN_00,
        .peripheral = MACHINE_PIN_AF_PERIPHERAL_SCI,
        .channel = 9,
        .group = 'A',
        .signal = MACHINE_PIN_AF_UART_SCK,
    },
    {
        .pin = BSP_IO_PORT_01_PIN_00,
        .peripheral = MACHINE_PIN_AF_PERIPHERAL_SPI,
        .channel = 1,
        .group = 'A',
        .signal = MACHINE_PIN_AF_SPI_MISO,
    },
    {
        .pin = BSP_IO_PORT_01_PIN_01,
        .peripheral = MACHINE_PIN_AF_PERIPHERAL_SCI,
    ...
    },
    {
        ...
        .channel = 9,
        .group = 'A',
        .signal = MACHINE_PIN_AF_UART_RXD,
    },
    {
        .pin = BSP_IO_PORT_01_PIN_01,
        .peripheral = MACHINE_PIN_AF_PERIPHERAL_SCI,
    ...
    },
    {
        ...
        .channel = 1,
        .group = 'A',
        .signal = MACHINE_PIN_AF_SPI_MOSI,
    },
    {
        .pin = BSP_IO_PORT_01_PIN_02,
        .peripheral = MACHINE_PIN_AF_PERIPHERAL_SCI,
    ...
    },
    {
        ...
        .channel = 9,
        .group = 'A',
        .signal = MACHINE_PIN_AF_UART_TXD,
    },
    {
        .pin = BSP_IO_PORT_01_PIN_02,
        .peripheral = MACHINE_PIN_AF_PERIPHERAL_SCI,
    ...
    },
    {
        ...
        .channel = 9,
        .group = 'A',
        .signal = MACHINE_PIN_AF_UART_CTS_RTS,
    },
    {
        .pin = BSP_IO_PORT_01_PIN_04,
        .peripheral = MACHINE_PIN_AF_PERIPHERAL_SCI,
        .channel = 9,
        .group = 'A',
        .signal = MACHINE_PIN_AF_UART_CTS,
    },
    {
        .pin = BSP_IO_PORT_01_PIN_05,
        .peripheral = MACHINE_PIN_AF_PERIPHERAL_SCI,
